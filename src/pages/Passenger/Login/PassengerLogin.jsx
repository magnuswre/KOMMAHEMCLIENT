...
const PassengerLogin = () => {
  ...
  return (
    <div className="PassengerLogin-container">
        ...
        <p className="PassengerLogin-form-text">Logga in till ditt konto här:</p>
          <div className="PassengerLogin-form-group">
            <label className="PassengerLogin-form-labels" htmlFor="email">Email*</label>
          ...
          <div className="PassengerLogin-form-group">
            <label className="PassengerLogin-form-labels" htmlFor="password">Lösenord*</label>
          ...
          <button id="PassengerLogin-btn" className="PassengerLogin-btn btn-primary" type="submit">Logga in</button>
        </form>
      </div>
  );
};
