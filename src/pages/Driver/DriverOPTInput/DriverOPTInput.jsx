        ...
        <div>
          <form>
            <div className="">
              ...
              <div className="DriverOPTInput-bottom">
                <div>
                  <a
                    onClick={() => verifyOTP()}
                    className="DriverOPTInput-verify-account-link"
                  >
                    Verify Account
                  </a>
                </div>
                ...
                <div>
                  ...
                  <a
                    className="DriverOPTInput-ResendLink"
                    style={{
